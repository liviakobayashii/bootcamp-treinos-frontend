    ...
    return (
        <div className="flex min-h-svh flex-col bg-background pb-24">
            <div className="container">
                ...
                <div>
                    <div className="relative flex h-[200px] w-full flex-col items-start justify-between overflow-hidden rounded-xl p-5 md:h-[300px]">
                        {coverImageUrl && (
                            <Image
                                src={coverImageUrl}
                                alt={name}
                        ...
                        <div className="relative flex w-full items-end justify-between">
                            <div className="flex flex-col gap-2">
                                <h2 className="font-heading text-2xl font-semibold leading-[1.05] text-background md:text-3xl">
                                    {name}
                                </h2>
