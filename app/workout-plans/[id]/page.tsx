    ...
    return (
        <div className="flex min-h-svh flex-col bg-background pb-24">
            <div className="container">
                <div className="relative flex h-[296px] shrink-0 flex-col items-start justify-between overflow-hidden rounded-b-[20px] pb-10 pt-5 px-4 md:h-[400px] md:rounded-xl md:mt-5">
                    ...
                    <div className="relative flex w-full items-end justify-between">
                        <div className="flex flex-col gap-3">
                            ...
                            <h1 className="font-heading text-2xl font-semibold leading-[1.05] text-background md:text-4xl">
                                Plano de Treino
                            </h1>
                        </div>
                    </div>
