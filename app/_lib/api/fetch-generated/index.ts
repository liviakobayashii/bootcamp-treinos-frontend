...
export const getGetApiAuthUrl = (path: string,) => {
...
export const getApiAuth = async (path: string, options?: RequestInit): Promise<getApiAuthResponse> => {
  
  return customFetch<getApiAuthResponse>(getGetApiAuthUrl(path),
  {      
    ...options,
    method: 'GET'
...
export const getPostApiAuthUrl = (path: string,) => {
...
export const postApiAuth = async (path: string, options?: RequestInit): Promise<postApiAuthResponse> => {
  
  return customFetch<postApiAuthResponse>(getPostApiAuthUrl(path),
  {      
    ...options,
    method: 'POST'
